  ...
  connections: {
    default: {
      ...
      settings: {
        ...
        // host: env('DATABASE_HOST', 'mongodb+srv://sglive-mongodb-cluster-93e2628e.mongo.ondigitalocean.com/admin?tls=true&authSource=admin&replicaSet=sglive-mongodb-cluster'),
        // srv: env.bool('DATABASE_SRV', true),
        // port: env.int('DATABASE_PORT', 27017),
        // database: env('DATABASE_NAME', 'SGLive'),
        // username: env('DATABASE_USERNAME', 'SGLive'),
        // password: env('DATABASE_PASSWORD', 'J968M0423v1gsuHN'),

        host: env(
          "DATABASE_HOST",
          "mongodb+srv://sglive-mongodb-cluster-93e2628e.mongo.ondigitalocean.com"
        ),
        srv: env.bool("DATABASE_SRV", true),
        port: env.int("DATABASE_PORT", 27017),
        database: env("DATABASE_NAME", "SGLive"),
